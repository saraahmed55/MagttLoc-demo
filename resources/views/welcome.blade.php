...
<!-- Section: Design Block -->
    ...
    <section class="background-radial-gradient overflow-hidden">
        ...
        #radius-shape-1 {
            ...
            top: -60px;
            left: -130px;
            background: radial-gradient(#0c5e8e, #78adef);
            overflow: hidden;
        }
        ...
        <div class="row gx-lg-5 align-items-center mb-5">
            ...
            <h1 class="my-4 display-6 fw-bold ls-tight" style="color: hsl(218, 81%, 95%)">
                MagttLoc:  <br />
                <span style="color: hsl(218, 81%, 75%)">Decimeter Indoor Localization System Using
                    Commercial Devices</span>
            </h1>
            <p class="mb-4 opacity-70" style="color: hsl(218, 81%, 85%)">
                A hybrid deep-learning-based indoor localization system that fuses magnetic measurements with WiFi RTT. MagttLoc yields a stable
                localization performance of decimeter-level accuracy improving upon the state-of-the-art systems in all experiments
            </p>
            </div>
            ...
            <div class="card bg-glass">
                ...
                <form name="myForm"onsubmit="return validateForm()" action="/points" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="/points" style="text-decoration:none;"><button class="btn btn-outline-success" type="button">Start Demo</button></a>
                    </div>
                </form>
                </div>
            </div>
